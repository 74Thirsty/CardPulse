            ...
            <View key={listing.id} style={styles.listingCard}>
              ...
              <CardSummary
                card={{
                  ...
                  name: listing.valuation?.card?.name ?? listing.cardId,
                  game: listing.valuation?.card?.game ?? 'Unknown',
                  edition: listing.valuation?.card?.edition ?? '—',
                  variant: listing.valuation?.card?.variant,
                  year: listing.valuation?.card?.year,
                  setNumber: listing.valuation?.card?.setNumber,
                  imageUrl: listing.valuation?.card?.imageUrl,
